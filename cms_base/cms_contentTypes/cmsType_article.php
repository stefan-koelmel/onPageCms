<?php // charset:UTF-8
class cmsType_article_base extends cmsType_contentData_show_base {

    function getName (){
        return "Artikel";
    }
    
    function article_show($contentData,$frameWidth) {
...
//            echo ("dyn2 $dynamic_2_type $dynamic_2_value <br>");
    ...
    function article_editContent($editContent,$frameWidth) {
...
function cmsType_article($contentData,$frameWidth) {
    ...
    $articleClass->article_show($contentData,$frameWidth);
}
