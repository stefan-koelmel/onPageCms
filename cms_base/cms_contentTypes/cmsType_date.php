...
class cmsType_date_base extends cmsType_contentData_show_base {
    ...
    function date_show($contentData,$frameWidth) {
        ...
        switch ($data[viewMode]) {
            case "list" :
                ...
                $res = $this->show_showList($dateId,$contentData,$innerWidth);                 
                break;
...
//                        $str.= "$dateInfo";
    ...
    function date_editContent($editContent,$frameWidth) {
...
function cmsType_date($contentData,$frameWidth) {
    ...
    $dateClass->date_show($contentData,$frameWidth);
}
