<?php // charset:UTF-8
class cmsType_frame_base extends cmsType_contentTypes_base {
    ...
    function show($contentData,$frameWidth,$anz) {
        ...
        if ($_SESSION[userLevel] > 6 AND !$contentData[dontShowDummy] ) {
        ...
        foreach($frameArray as $frameName => $frameData) {
            ...
            if ($layout) {
                ...
                if ($_SESSION[edit]) echo ("<div class='spacer spacerDrop'>");//</div>");
