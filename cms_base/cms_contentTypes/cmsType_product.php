<?php // charset:UTF-8
class cmsType_product_base extends cmsType_contentData_show_base {
    ...
    function product_show($contentData,$frameWidth) {
    ...
    function product_showList($contentData, $frameWidth) {
        ...
        $productList = $this->product_getList($contentData); // cmsProduct_getList($filter,$sort,"___assoId");
...
function cmsType_product($contentData,$frameWidth) {
    ...
    $productClass->product_show($contentData,$frameWidth);
}
