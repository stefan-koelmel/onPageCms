...
//        
    ...
    function cms_Settings_showModul($dontShow,$hidden=1,$addEditClass="") {
        ...
        //foreach ($_SESSION[cmsSettings] as $key => $value) $out .= "$key = $value <br/>";
        $mobilPages = $_SESSION[cmsSettings][mobilPages];
        if ($mobilPages) {
            ...
            foreach ($list as $key => $value) {
                ...
                $out .= "<div class='$divClass' id='$divId' style='$style'>";
                $out .= "<img src='/cms_".$GLOBALS[cmsVersion]."/cmsImages/cmsTarget".$key.".png'><br/>";
                $out .= "$value";
                $out .= "</div>";
            ...
            if (!$showDirection) {
                $_SESSION[target_orientation] = "Portrait";
                $showDirection = $_SESSION[target_orientation];
            }
            ...
            foreach ($list as $key => $value) {
                ...
                $out .= "<div class='$divClass' id='$divId' style='$style'>";
                $out .= "<img src='/cms_".$GLOBALS[cmsVersion]."/cmsImages/cmsDirection".$key.".png'><br/>";
                $out .= "$value";
                $out .= "</div>";
