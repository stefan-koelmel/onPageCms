...
class cmsAdmin_articles_base extends cmsAdmin_editClass_base {
    ...
    function admin_listSettings() {
        $res = $this->articles_showList();
        return $res;
    }
    
    function show($frameWidth){
        if (!function_exists("cmsArticles_get")) {
    ...
    function show_list() {
        $this->articlesList($this->frameWidth);
    }
    
    function show_new() {
        $projectId = 0;
        $this->articlesEdit($projectId,$this->frameWidth); 
    }
    ...
    function articlesList($frameWidth) {
        ...
        $this->admin_show_list($articlesList);
        return 0;
        ...
        $showList = $this->articles_showList();
