...
//    }
    ...
    function editButtons_own($buttonList, $saveData) {
        ...
        $addData[name] = "Thumbnails löschen";
        $addData[value] = "deleteThumb";
        $buttonList[deleteThumb] = $addData;
        
        unset($buttonList[editShow]);
...
//        
    ...
    function deleteThumbs_ofFile($fileName,$folder) {
        ...
        $str = "Lösche Thumbnail Bilder von '$fileName' <br>";

        if ($anz>0) $str .= "$anz Thumbnails gelöscht";
        else $str .= "Keine Thumbnails vorhanden";
        cms_infoBox($str);
        return $anz;
    }
