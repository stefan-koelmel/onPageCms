...
class cmsAdmin_product_base extends cmsAdmin_editClass_base {
    ...
    function show_list() {
        $this->productlist($this->frameWidth);
    }
    
    function show_new() {
        $projectId = 0;
        $this->productEdit($projectId,$this->frameWidth); 
    }
    ...
    function productList($frameWidth) {
        ...
        $this->admin_show_list($productList);
        return 0;
...
function cms_admin_productClass($ownAdminPath="") {
...
function cms_admin_product($frameWidth,$ownAdminPath=""){
    $class = cms_admin_productClass($ownAdminPath);
