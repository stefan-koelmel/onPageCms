...
//        $res = $this->kjh();
    ...
    function show(){
        if (!function_exists("cmsProject_get")) {
            echo ("Projekte sind deaktiviert !<br>");
            return 0;
        }
        $view = $_GET[view];
        $projectId = $_GET[id];
    ...
    function show_list() {
        $this->projectList($this->frameWidth);
    }
    
    function show_new() {
        $projectId = 0;
        $this->projectEdit($projectId,$this->frameWidth); 
    }
...
//        if (is_array($this->listView) AND count($this->listView)) {
//            $showData = $this->listView;
//        }
//        
//        $sortetListShow = $this->admin_getSortet_list();
//        if (is_array($sortetListShow)) {
//            show_array($showList[image]);
//            show_array($sortetListShow[image]);
//            // $showList = $sortetListShow;
//        }
//        
//        $frameWidth = $this->frameWidth - 10;
//        
...
function cms_admin_projectClass($ownAdminPath) {
