$(".faq_main").click(function(){
    ...
    if (hasClass) {
        ...
        $(".faq_mainContainer").addClass("faq_mainContainer_close");
        $(".faq_main").addClass("faq_main_close");
        $(".faq_main_content").addClass("faq_main_content_hidden");   
        
        
        $(this).parent().removeClass("faq_mainContainer_close");
        ...
        $(this).parent().addClass("faq_mainContainer_close");
    }
})
