...
$(".cmsGalleryThumbnail").click(function(){
    ...
    $(this).parent().children(".cmsGalleryThumbnail").removeClass("cmsGalleryThumbnail_selected");
    $(this).addClass("cmsGalleryThumbnail_selected");
    // Hide ALL Image
    
    $(this).parent().parent().parent().children(".cmsGalleryImageFrame").children(".cmsGalleryImage").addClass("cmsGalleryImage_hidden");
    // Show Image
    $(this).parent().parent().parent().children(".cmsGalleryImageFrame").children(".cmsGalleryImage_"+id).removeClass("cmsGalleryImage_hidden");
})
