<?php // charset:UTF-8
class cmsType_table_base extends cmsClass_content_show {
   ...
   function contentType_editContent() {
        ...
        $res = array();
        $res[$mainTab] = array();
        $res[$mainTab][showName] = $this->lga("content","tableTab");
        ...
        $addToTab = "Column";
        $res[$addToTab] = array();
        $res[$addToTab][showName] = $this->lga("content","tableColumnTab");
        ...
        $addToTab = "Rows";
        $res[$addToTab] = array();
        $res[$addToTab][showName] = $this->lga("content","tableRowsTab");
        $res[$addToTab][showTab] = "Simple";
        ...
        $addToTab = "Content";
        $res[$addToTab] = array();
        $res[$addToTab][showName] = $this->lga("content","tableContentTab");
        $res[$addToTab][showTab] = "Simple";
        $add = array();
        $add[text] = "Inhalt";
...
function cmsType_table($contentData,$frameWidth) {
    ...
    return $tableClass->show($contentData,$frameWidth);
}
