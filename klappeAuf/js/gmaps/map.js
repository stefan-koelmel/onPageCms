...
$('.newwindow').click(function(){window.open(this.href,'_blank');return false;});            
				map.add(function() {
					$('#map_canvas').gmap({'center': '49.0101496, 8.405277', 'zoom': 17, 'disableDefaultUI':true, 'callback': function() {
						var self = this;
						self.addMarker({'position': this.get('map').getCenter() }).click(function() {
							self.openInfoWindow({ 'content': 'Klappe auf<br />Kreuzstra&szlig;e 3<br />76133 Karlsruhe<p /><a href="http://maps.google.de/maps?q=klappe+auf+karlsruhe&amp;hl=de&amp;ie=UTF8&amp;hq=klappe+auf&hnear=Karlsruhe,+Baden-W%C3%BCrttemberg&amp;t=m&amp;z=16" class="newwindow" target="_blank">In Google-Maps aufrufen</a>'}, this);
						});	
					}});
				}).load();
			});