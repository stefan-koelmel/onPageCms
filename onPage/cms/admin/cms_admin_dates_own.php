...
//        $editShow[mainId][needed] = 0;
        ...
        $editShow[toDate][needed] = 0;
         ...
         // Rubrik - AutoComplete
        $editShow[category] = array("name"=>"Rubrik","show"=>0,"type"=>"autoComplete","width"=>"standard");
        ...
        $editShow[location][needed] = 0;
        $editShow[location][needError] = "Kein Veranstalter ausgewählt";

       
        // Region
        $editShow[region] = array("name"=>"Stadt - Region","show"=>0,"type"=>"autoComplete","dataSource"=>"category","width"=>"standard","id"=>"queryRegion");
        ...
        $editShow[time][next] = "toTime";
         
        $editShow[time][needed] = "time";
        $editShow[time][needError] = "Keine Uhrzeit ausgewählt";
        
        $editShow[toTime]     = array("name"=>"bis Uhrzeit","show"=>1,"type"=>"time","mode"=>"simple","width"=>"small");
        $editShow[toTime][next] = "subName";
        $editShow[toTime][nextDelimiter] = "bis";
        $editShow[toTime][needed] = 0; //"time";
        $editShow[toTime][needError] = "Keine Uhrzeit ausgewählt";
        
        
        $editShow[subName]    = array("name"=>"Termin-Zusatz","show"=>1,"type"=>"text","width"=>"60%");
...
//        $editShow[highlight] = array("name"=>"Tagestipp","show"=>0,"type"=>"checkbox","width"=>"standard");
...
//        $editShow[longInfo][showLevel] = 8;
        ...
        $editShow[locationStr] = array("name"=>"Veranstaltung-Ort (nicht DB)","show"=>0,"type"=>"text","disabled"=>0,"readOnly"=>0,"width"=>"standard");
...
//        $editShow[data][needed] = 0;
        ...
        $editShow[cancel] = array("name"=>"Abgesagt","show"=>0,"type"=>"checkbox","width"=>"standard");
