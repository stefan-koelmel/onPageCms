<?php // charset:UTF-8
 ...
 class cmsAdmin_importExport extends cmsAdmin_importExport_base {

     function __init() {

        $this->serverPath = "http://cms.stefan-koelmel.com/skCom/cms/";
        $this->phpGetFile = "getData.php";

        $data = array();
        $data[serverPath] = "http://cms.stefan-koelmel.com/skCom/cms/";
        $data[phpGetFile] = "getData.php";
        $data[tables][startName]= "skCom";
