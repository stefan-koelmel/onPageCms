<?php // charset:UTF-8
class cmsType_categoryList_base extends cmsType_contentTypes_base {

    function getName (){
        return "Kategorien List";
    }

    function categoryList_show($contentData,$frameWidth) {
    ...
    function categoryList_editContent($editContent,$frameWidth) {
        $res = array();
...
function cmsType_categoryList_class() {
...
function cmsType_categoryList($contentData,$frameWidth) {
    //  echo ("categoryList");
    if ($GLOBALS[cmsTypes]["cmsType_categoryList.php"] == "own") $categoryListClass = new cmsType_categoryList();
    else $categoryListClass = new cmsType_categoryList_base();

    $categoryListClass->categoryList_show($contentData,$frameWidth);
}



function cmsType_categoryList_editContent($editContent,$frameWidth) {
    if ($GLOBALS[cmsTypes]["cmsType_categoryList.php"] == "own") $categoryListClass = new cmsType_categoryList();
    else $categoryListClass = new cmsType_categoryList_base();
...
function cmsType_categoryList_getName() {
    $categoryListClass = cmsType_categoryList_class();
