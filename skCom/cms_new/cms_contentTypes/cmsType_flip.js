...
$(".cmsFlipFrameSelector ").click(function(){
    layerNr = $(this).attr("id");
    // name    = $(this).attr("name");
    
    help = $(this).parent().attr("class");
    width = $(this).parent().children(".cmsFlipTitleFrame").children(".frameWidth").text();
    contentId = $(this).parent().attr("id");
    
    // contentName = "layer_"+contentId+"_"+layerNr;
    ...
    // $(this).addClass("cmsFlipFrameSelectorSelected");
    // alert("Click SELECT layerNr = "+layerNr+" contentId = "+contentId+" select="+FlipFrameSelect);
    // var FlipFrameSelect = contentId;
