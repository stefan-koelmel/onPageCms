...
function cms_page_getSortList($forNavi=0) {
    // echo ("<h3>cms_page_getSortList($forNavi)</h3>");
    $navi_List = array();
    ...
    if (is_null($showLevel)) {
        $showLevel = 0;
        $_SESSION[showLevel] = $showLevel;
    }
...
//    echo ("<h4>create Page GroupeListt</h4>");
    ...
    // echo ("Ebene 1 ".count($pageListUnsort)."<br>");
    // 1.Ebene
    foreach ($pageListUnsort as $pageName => $page) {
   // for ($i=0;$i<count($pageListUnsort);$i++) {
        //$page = $pageListUnsort[$i];
    ...
    // Set PAGE GROUPLIST 
    $_SESSION[pageGroupList] = $pageList;
    return $pageList;
